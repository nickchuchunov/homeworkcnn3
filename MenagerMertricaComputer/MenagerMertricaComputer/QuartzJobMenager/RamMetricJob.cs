...
namespace MenagerMertricaComputer
{
    public class RamMetricJob : IJob
    {
        ...
        RamMetricJob(AcessAgent1 acessAgent1)
        {
        ...
        public Task Execute(IJobExecutionContext context)
        {
            ...
            string SQLCommand = "SELECT MAX(Time) FROM rammetrica";
            ...
            IList<RamMenegertMetrica> df = _acessAgent1.GetAllRamMetrics(new GetAllRamMetricsApiRequest { StartTimr = toParameter, EndTime = fromParameter });


            //Записать df в базу данных

            foreach (RamMenegertMetrica df1 in df)
            {
                string ConnectionString = "Data Source = metricsmeneger.db; Version = 3; Pooling = true; Max Pool Size = 100;";
                ...
                cmd.CommandText = "INSERT INTO rammetrica(Id, Value, Time) VALUES(@Id, @Value, @Time)";
