...
namespace MenagerMertricaComputer
{
...

    {
      ...
      public readonly AcessAgent1 _acessAgent1;
        ...
        CpuMetricJob(AcessAgent1 acessAgent1)
        {
        ...
        public Task Execute(IJobExecutionContext context) 
        {
            ...
            string SQLCommand = "SELECT MAX(Time) FROM cpumetrica";
          ...
          IList<CpuMenegerMetrica>  df = _acessAgent1.GetAllCpuMetrics(new GetAllCpuMetricsApiRequest { StartTimr = toParameter, EndTime = fromParameter });


            //Записать df в базу данных

            foreach (CpuMenegerMetrica df1 in df) 
            {
                string ConnectionString = "Data Source = metricsmeneger.db; Version = 3; Pooling = true; Max Pool Size = 100;";
                ...
                cmd.CommandText = "INSERT INTO cpumetrica(Id, Value, Time) VALUES(@Id, @Value, @Time)";
