...
{
    public class NetworcMetricJob : IJob
    {
        ...
        NetworcMetricJob(AcessAgent1 acessAgent1)
        {
        ...
        public Task Execute(IJobExecutionContext context)
        {
            ...
            string SQLCommand = "SELECT MAX(Time) FROM networkmetrica";
            ...
            IList<NetworcMenegerMetrica> df = _acessAgent1.GetAllNetworcMetrics(new GetAllNetvorcMetricsApiRequest { StartTimr = toParameter, EndTime = fromParameter });


            //Записать df в базу данных

            foreach (NetworcMenegerMetrica df1 in df)
            {
                string ConnectionString = "Data Source = metricsmeneger.db; Version = 3; Pooling = true; Max Pool Size = 100;";
                ...
                cmd.CommandText = "INSERT INTO networkmetrica(Id, Value, Time) VALUES(@Id, @Value, @Time)";
